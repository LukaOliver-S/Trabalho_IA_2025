...
PICK_POSES = {
    1: [0.320, 0.84, 0.5443,  1.78, 0.0],
    2: [0.0, 0.84, 0.5443,  1.78, 0.0],
    3: [-0.320, 0.84, 0.5443,  1.78, 0.0],
    4: [0.400, 0.780, 0.679,  1.419, 0.0],
    5: [0.1333, 0.780, 0.679,  1.419, 0.0],
    6: [-0.1333, 0.780, 0.679,  1.419, 0.0],
    7: [-0.400, 0.780, 0.679,  1.419, 0.0],
    8: [0.350, 0.930, 0.4693,  1.284, 0.0],
    9: [0.1166, 0.930, 0.4693,  1.284, 0.0],
    10: [-0.1166, 0.930, 0.4693,  1.284, 0.0],
    11: [-0.350, 0.930, 0.4693,  1.284, 0.0],
    12: [0.325, 1.220, 0.019, 1.284, 0.0],
    13: [0.1083, 1.220, 0.019, 1.284, 0.0],
    14: [-0.1083, 1.220, 0.019, 1.284, 0.0],
    15: [-0.325, 1.220, 0.019, 1.284, 0.0]
}

STORE_POSES = {
    1: [0.320, 0.86, 0.5443,  1.74, 0.0],
    2: [0.0, 0.86, 0.5443,  1.74, 0.0],
    3: [-0.320, 0.86, 0.5443,  1.74, 0.0],
    4: [0.400, 1.125, 0.074,  1.725, 0.070],
    5: [0.1333, 1.125, 0.074,  1.725, +0.130],
    6: [-0.1333, 1.125, 0.074,  1.725, -0.130],
    7: [-0.400, 1.125, 0.074,  1.725, -0.070],
    8: [0.350, 0.960, 0.4693,  1.229, 0.0],
    9: [0.1166, 0.960, 0.4693,  1.229, 0.0],
    10: [-0.1166, 0.960, 0.4693,  1.229, 0.0],
    11: [-0.350, 0.960, 0.4693,  1.229, 0.0],
    12: [0.325, 1.275, 0.019, 1.174, 0.0],
    13: [0.1083, 1.275, 0.019, 1.174, 0.0],
    14: [-0.1083, 1.275, 0.019, 1.174, 0.0],
    15: [-0.325, 1.275, 0.019, 1.174, 0.0]
}
